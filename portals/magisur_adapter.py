...
class MagisurAdapter(BaseSiteAdapter):
    def __init__(self):
        super().__init__("https://magisur.cl")

    def discover_model_urls(self) -> List[str]:
        # Catalog is in main page
        ...
        for a in soup.find_all('a', href=True):
            href = a['href']
            # Based on inspection, URLs look like https://magisur.cl/casa-t179/
    ...
    def parse_model_page(self, url: str) -> Optional[ModelSchema]:
        ...
        filtered_imgs = [
             ...
             and not any(x in src.lower() for x in ['logo', 'icon', 'webpay', 'svg', 'data:', 'fb-', 'instagram', 'avatar', 'mesa-de-trabajo', 'elementor'])
        ...
        return ModelSchema(
            ...
            description="Fabricación de casas prefabricadas en la Región de La Araucanía.",
