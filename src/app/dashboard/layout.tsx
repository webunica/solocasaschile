        ...
        <div className="flex h-screen bg-slate-50 text-slate-800">
            ...
            <aside className="w-64 bg-white border-r border-slate-200 flex-col hidden md:flex shrink-0">
                ...
                <nav className="flex-1 p-4 flex flex-col gap-2">
                    ...
                    <Link href="/dashboard/impressions" className="px-4 py-3 text-slate-500 hover:bg-slate-50 hover:text-[#3200C1] rounded-xl font-bold flex items-center gap-3 transition-colors">
                    ...
                    {isAdmin && (
                        <>
                            ...
                            <Link href="/dashboard/social" className="px-4 py-3 text-slate-500 hover:bg-slate-50 hover:text-[#3200C1] rounded-xl font-bold flex items-center gap-3 transition-colors">
