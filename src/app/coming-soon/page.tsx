...
export default async function ComingSoonPage() {
    ...
    return (
        <div className="min-h-screen bg-[#020110] text-white selection:bg-[#37FFDB] selection:text-[#3200C1] overflow-hidden flex flex-col items-center justify-between relative font-sans antialiased">
            ...
            {/* Background Carousel of Modern Models - Ultra subtle */}
            ...
            {/* Andes Cordillera - WHITE LINES as requested */}
            ...
            <div className="absolute top-[20%] right-[-5%] w-[30%] h-[30%] bg-[#37FFDB]/10 rounded-full blur-[100px] z-0"></div>
                ...
                <div className="flex items-center gap-4">
                    {logoUrl ? (
                        <img 
                            src={logoUrl} 
                            alt={siteName} 
                            className="h-10 md:h-16 w-auto drop-shadow-sm brightness-110" 
                        />
                    ) : (
            ...
            <main className="flex-1 flex flex-col items-center justify-center text-center px-6 relative z-10 w-full max-w-5xl space-y-10 md:space-y-12 pb-16 md:pb-24">
                ...
                <div className="space-y-6">
                    ...
                    <h1 className="text-4xl md:text-9xl font-black leading-[1] md:leading-[0.9] tracking-tighter">
                        TU HOGAR <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#37FFDB] to-[#3200C1]">EVOLUCIONADO</span>
                    </h1>
                    
                    <p className="text-slate-400 text-base md:text-2xl font-medium max-w-3xl mx-auto leading-relaxed px-2">
                ...
                {/* Info Cards Grid - Delicate Dark Mode */}
